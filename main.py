...
def parent_dashboard():
    ...
    ).order_by(ChoreSubmission.date_submitted.desc()).all()  # type: ignore[attr-defined]  # Newest first
...
def add_chore_type():
    ...
    description = request.form.get('description')  # e.g., "Take trash and recycling to curb"
